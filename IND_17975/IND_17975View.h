...
constexpr RECT BIG = { 0, 0, long(2.4 * BASE + 0.5), long(2.7 * BASE + 0.5) };
constexpr RECT SLIM = { 0, 0, long(BASE), long(3 * BASE)};
constexpr RECT THINNER = { 0, 0, long(1.6 * BASE + 0.5), long(2.7 * BASE + 0.5)};
...
private:
	...
	void TRT(CDC* pDC, POINT origin, float angle, bool rightMultiply = false);
